document.addEventListener("DOMContentLoaded", function() {
    const questions = [
...

        {
            ...
            correct: 0,
            feedback: "The m flag is used to preform multiline matching."
        },
...

        {
            ...
            correct: 1,
            feedback: "The + characters matches one or more of the preceding element."
        },
    ...
    // Will store the timer interval refrence
    let countdown;

    // Set time limit for each question (in seconds)
    let timeLeft = 30;

    // Flah to prevent multiple answer selections
    let answerSelected = false;

    // Labels for multiple choice answeres
    ...
    function displayQuestion() {
        ...
        // Hide any feedback from the previous quesiton
        ...
        // Get te current quesiton object
        ...
        function checkAnswer(index) {
            ...
            // Get the corrent answer index from the current quesiton
            const correctIndex = questions[currentQuestion].correct;

            // Compare with selected answer index to determine if correct
            const isCorrect = index === correctIndex;

            // Get refrence to the feedback element
            const feedback = document.getElementById("feedback");

            // Set CSS class based on wether answer is correct
            ...
            if (isCorrect) {
                // For correct answers
                feedback.innerHTML = 
                `<strong>Correct!</strong> The answer is ${correctLabel}) ${correctAnswer} <br> ${questions[currentQuestion].feedback}`;
            }
        }
        ...
        document.getElementById("next-button").addEventListener("click", () => {
            // Only advance if an answer was selected and there are more quesitons
